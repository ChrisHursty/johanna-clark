...
<section class="container-fw content-bg">
    ...
    <div class="container">
        <div class="row">
            <a class="jch-btn align-center" target="_blank" rel="nofollow noopener" href="https://johannaclark.glossgenius.com/"><span>Book An Appointment<i style="margin-left: 6px;" class="fas fa-external-link-alt"></i></span></a>
        </div>
    </div>
